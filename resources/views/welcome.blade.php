...
<body
    ...
    <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-es-lg rounded-ee-lg lg:rounded-ss-lg lg:rounded-ee-none">
        <h1 class="mb-1 font-medium">Mueblería Jazmín</h1>
        <p class="mb-4 text-[#706f6c] dark:text-[#A1A09A]">
            Taller especializado en diseño, fabricación y montaje de muebles de melamina a medida.
        </p>

        <ul class="mb-6 space-y-2 text-sm text-[#706f6c] dark:text-[#A1A09A]">
            <li>• Cocinas, placards y muebles TV a medida</li>
            <li>• Materiales y herrajes de calidad</li>
            <li>• Medición, fabricación y montaje en domicilio</li>
        </ul>

        <p class="text-xs text-[#706f6c] dark:text-[#A1A09A]">
            Contacto: contacto@muebleriajazmin.com · 
        </p>
        <p>Tel: +54 9 11 1234 5678</p>
            ...
            <div
                ...
                {{-- Logo empresa --}}
                <div class="w-full h-full flex items-center justify-center p-6 lg:p-8">
                    <img src="/images/muebles_logo.png" alt="Muebles MJ - logo" class="max-w-full h-auto object-contain rounded-lg shadow-[0px_10px_30px_rgba(0,0,0,0.12)]" />
                </div>
